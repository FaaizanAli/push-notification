...
{{--                        <img src="{{asset('logo/login.jpg')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">--}}
...
{{--                                        <img src="{{asset('logo/logo2.png')}}" class="sign-favicon ht-70" alt="logo">--}}
                                    </div>
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            @if (Session::has('login_error_exception'))
                                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                    ...
                                                    <span class="alert-inner--text"><strong>Warning!</strong> {{ Session::get('login_error_exception') }}</span>
                                            ...
                                            @if (Session::has('login_error'))
                                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                    <span class="alert-inner--icon"><i class="fe fe-info"></i></span>
                                                    <span class="alert-inner--text"><strong>Warning!</strong> {{ session()->get('login_error.message') }}</span>
                                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
                                                </div>
                                            ...
                                            <form action="{{route('admin_login')}}" method="POST" id="login">
                                                @csrf
